 ...
 <section className='project'>
                        <section class='projectLeft'>
                            ...
                            <p className='projectDescription'>
                                ...
                                <br/>
                                <br/>
                                {/* <a class='repoUrl' href='https://mywebdevglossary.com/'>Live Site</a> |  */}
                                <section class='repoSection'><a class='repoUrl' href='https://github.com/kylebaugh/personal-project'>GitHub Repo</a></section>
